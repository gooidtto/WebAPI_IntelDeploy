...
lines = [
    ...
    link(PUBLIC_DOMAIN, 443, {"encryption":"none","security":"tls","sni":PUBLIC_DOMAIN,"fp":FP,"alpn":"http/1.1","type":"ws","path":WSPATH,"host":PUBLIC_DOMAIN}, "VLESS WS TLS · Railway Domain"),
